...
return [
    ...
    'Asset_Checkin_Notification' => 'Актив возвращен: [:tag]',
    ...
    'Confirm_component_checkin' => 'Подтверждение возврата компонента',
    ...
    'Confirm_component_delivery' => 'Подтверждение доставки компонента',
    ...
    'acceptance_asset_accepted_to_user' => 'Вы подтвердили элемент, назначенный вам на :site_name',
    ...
    'admin_has_created' => 'Администратор создал для вас учетную запись на сайте :web website. Пожалуйста, найдите ваше имя пользователя ниже и перейдите по ссылке, чтобы установить пароль.',
    'asset' => 'Актив',
